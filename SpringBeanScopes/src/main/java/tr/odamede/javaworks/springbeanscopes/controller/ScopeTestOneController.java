...
@RequestMapping(value = "/v1/scope-test-one")
@RestController
public class ScopeTestOneController {
    ...
    public ScopeTestOneController(DefaultScopeBean defaultScopeBean, PrototypeScopeBean prototypeScopeBean, RequestScopeBean requestScopeBean, SessionScopeBean sessionScopeBean) {
